...
function Userlist() {
    ...
    const getUserData = async () => {
        const reqData = await fetch("http://localhost/reactcrudphp/phpcrud/api/user.php");
        const resData = await reqData.json();
        setUserData(resData);
    }

    const handleDelete = async (id) => {
        const res = await axios.delete("http://localhost/reactcrudphp/phpcrud/api/user.php/" + id);
